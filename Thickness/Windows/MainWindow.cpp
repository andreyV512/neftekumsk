...
MainWindow::MainWindow()
	: oThicknessViewer(thicknessViewer)
{}
// 	 ---------------------------------------------------------------------
...
//	testCheckBox2.Size(width, 69, 525, 20);
	...
	MoveWindow(oThicknessViewer.hWnd , 0, y, r.right, t, true);
...
unsigned MainWindow::operator()(TCreate &m)
{
    ...
    CREATE_CHILD_WINDOW(m.hwnd, ThicknessViewer);
	//test
