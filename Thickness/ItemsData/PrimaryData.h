...
public:
	...
	//static const unsigned LessMinimumEnergy      = 1 << 3;
	//static const unsigned ValueLessThreshold     = 2 << 3;
	//static const unsigned ThicknessLessThreshold = 3 << 3;	
	//
	//
	//
	//static const unsigned GreaterMaximumEnergy   = 7 << 3;
	...
	static const unsigned Undefined              = 1 << 4;
	static const unsigned LessMinimumEnergy      = 2 << 4;
	static const unsigned ValueLessThreshold     = 3 << 4;
	static const unsigned ThicknessLessThreshold = 4 << 4;	
	static const unsigned GreaterMaximumEnergy   = 5 << 4;
